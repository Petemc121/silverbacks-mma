  ...
  const sessions = [
    {
      ...
      animationClass: "session nogi nogi-animation monday",
      title: "Adults No-gi",
      time: "6:30am - 8:00am",
    },
    {
      ...
      animationClass: "session nogi nogi-animation friday",
      title: "Adults No-gi",
      time: "6:30am - 8:00am",
    },
    {
      ...
      animationClass: "session kids kids-animation monday",
    ...
    },
    {
      ...
      animationClass: "session kids kids-animation thursday",
      title: "Kids 5-10 years old BJJ",
      time: "4:30pm - 5:15pm",
    },
    {
      ...
      animationClass: "session teens teens-animation monday",
    ...
    },
    {
      ...
      animationClass: "session nogi nogi-animation tuesday",
      title: "Adults BJJ",
      time: "7:00pm - 8:30pm",
    },
    {
      ...
      animationClass: "session wrestling wrestling-animation friday",
      title: "Wrestling",
      time: "7:00pm - 9:00pm",
    },
    {
      ...
      animationClass: "session mma mma-animation monday",
      title: "MMA",
      time: "8:00pm - 9:30pm",
    },
    {
      ...
      animationClass: "session nogiEvening nogiEvening-animation wednesday",
      title: "Adults No-gi",
      time: "8:00pm - 9:30pm",
    },
    {
      ...
      animationClass: "session gi gi-animation thursday",
      title: "Adults BJJ",
      time: "8:00pm - 9:30pm",
    },
  ];
